...
const DashboardPage = () => {
  ...
  const [view, setView] = useState<"dashboard" | "employ" | "user">(
    "dashboard"
  );
  ...
  const [statusUpdateMap, setStatusUpdateMap] = useState<
    Record<string, { status: "active" | "inactive"; description: string }>
  >({});
        ...
        <main
          ...
          {view === "dashboard" ? (
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                {trafficData.map((item, index) => (
                  <div
                    key={index}
                    className={`${themeClasses.card} rounded-lg shadow-sm p-6 transition-all hover:shadow-md`}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                <div
                  className={`${themeClasses.card} rounded-lg shadow-sm p-6`}>
            ...
            <>
              ...
              {/* Table View */}
              <div
                className={`${themeClasses.card} rounded-lg shadow-sm overflow-hidden`}>
                    ...
                    <tbody
                      ...
                      {displayData.length > 0 ? (
                          ...
                          (item: {
                            ...
                            <tr
                              ...
                              <td className="relative px-6 py-4 whitespace-nowrap">
                                {statusUpdateMap[item.id]?.status ===
                                "active" ? (
                                ...
                                {statusPopoverId === item.id && (
                                  <div className="absolute top-full mt-2 right-0 w-64 bg-white shadow-lg rounded-lg p-4 z-50 border border-gray-200">
                                    ...
                                    <textarea
                                      value={
                                        statusUpdateMap[item.id]?.description ||
                                        ""
                                      }
                                      onChange={(e) =>
                                        setStatusUpdateMap((prev) => ({
                        ...
                        <tr>
                          <td
                            colSpan={6}
                            className={`px-6 py-4 text-center text-sm ${themeClasses.table.cell}`}>
                            No data available
                          </td>
                        </tr>
                      )}
