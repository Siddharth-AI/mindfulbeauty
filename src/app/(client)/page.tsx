    ...
    "Home Service": [
      {
        ...
        answer:
          "We offer a wide range of home services including facials, manicures, pedicures, massages, hair spas, and waxing. Our skilled professionals bring the salon experience right to your doorstep.",
      },
      {
        question: "How do I book a home service appointment?",
        answer:
          "You can easily book a home service appointment through our website or mobile app. Simply select your desired service, date, time, and location, and confirm your booking. You can also call us directly.",
      },
      {
        question: "What areas do you provide home services in?",
        answer:
          "Our home services are currently available in major metropolitan areas including Delhi, Mumbai, Bangalore, Chennai, and Hyderabad. Please check our website for a complete list of service areas.",
      },
      {
        question: "Is there a minimum booking amount for home services?",
        answer:
          "Yes, there is a minimum booking amount of ₹500 for all home service appointments. This helps us ensure the best quality service and manage our logistics efficiently.",
      },
      {
        question: "What products do you use for home services?",
        answer:
          "We use only high-quality, professional-grade products from reputable brands for all our home services, ensuring safety, effectiveness, and a premium experience. Our products are suitable for various skin and hair types.",
      },
    ],
    "Salon Service": [
      {
        ...
        answer:
          "While walk-ins are welcome, we highly recommend booking an appointment for salon services to ensure availability and minimize your waiting time, especially during peak hours.",
      },
      {
        question: "What are your salon operating hours?",
        answer:
          "Our salon typically operates from 10:00 AM to 8:00 PM, Monday through Saturday. We are closed on Sundays and major public holidays. Please check our website for specific holiday hours.",
      },
      {
        question: "Can I choose my stylist/therapist for salon services?",
        answer:
          "Yes, you can request a specific stylist or therapist when booking your salon appointment, subject to their availability. We'll do our best to accommodate your preference.",
      },
      {
        question: "Do you offer group bookings or packages?",
        answer:
          "Absolutely! We offer various group booking options and customized packages for special occasions like bridal parties, birthdays, and corporate events. Please contact us for details and pricing.",
      },
      {
        question: "What safety measures are in place at your salon?",
        answer:
          "We prioritize the health and safety of our clients and staff. Our salon adheres to strict hygiene protocols, including regular sanitization, use of disposable tools where possible, and mandatory mask-wearing for staff.",
      },
    ],
  };
    ...
    <>
      ...
      "
        ...
        <div className="relative z-10 w-full flex flex-col items-center justify-center px-4 mt-[25vh]">
          ...
          <div className="mt-[90px] w-full max-w-xl flex flex-col items-center">
            {/* Toggle buttons */}
            <div
              className="flex gap-0 mb-6 rounded-full shadow-lg overflow-hidden w-full"
      ...
      <section className="max-w-3xl mx-auto min-h-screen py-12 flex flex-col items-center">
        ...
        <div className="flex space-x-14 mb-8">
          <button
            className={`text-[1.125rem] font-semibold pb-1 border-b-2 ${
              activeTab === "salon"
        ...
        <div className="flex flex-col items-center mt-16">
          ...
          <p
            ...
            style={{ maxWidth: "80vw" }}>
            No salon/freelancer nearby at the moment, but we’re growing! Come
            back in a month—we might be closer than you think.
          </p>
              ...
              {steps.map(({ img, step, title, desc }, i) => (
                <div className="text-center" key={i}>
                  <div className="relative mb-4">
                    <img src={img} alt={title} className="w-fit mx-auto" />
                    <div className="absolute top-0 right-[80px] rounded-full w-14 h-14 flex items-center justify-center bg-[#33A6DB] shadow-lg">
                      <span className="text-[22px] font-bold font-Montserrat text-white leading-none">
                        {step}
                      </span>
                    </div>
                  </div>
