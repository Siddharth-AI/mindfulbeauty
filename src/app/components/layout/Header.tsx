...
const MENU_STRUCTURE = [
  ...
  { type: "main", label: "Home" },
  {
    type: "main",
    label: "High Thinking",
    subItems: ["Mindset", "Our Brand", "Our Commitment", "Our Impact"],
  },
  {
    type: "main",
    label: "High Talent",
    subItems: ["Our Team", "Our Services"],
  },
...
const HeaderBar = () => {
  ...
  const [user, setUser] = useState<{ name: string } | null>(null); // null=guest, or { name: "User" }
  ...
  const MenuItem: React.FC<MenuItemProps> = ({ label, isSubItem }) => (
    <div
  ...
  const renderMenu = () => (
    <nav
      ...
      <ul className="space-y-1">
        <li className="px-4 py-2 text-base font-semibold text-gray-800 border-b border-gray-200">
